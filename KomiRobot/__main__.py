...
import KomiRobot.modules.no_sql.users_db as sql
from KomiRobot import BOT_USERNAME
from KomiRobot import LOGGER as log
from KomiRobot import OWNER_ID, OWNER_USERNAME, SUPPORT_CHAT, TOKEN
from KomiRobot import Abishnoi as pbot
from KomiRobot import StartTime, dispatcher, telethn, updater

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from KomiRobot.modules import ALL_MODULES
from KomiRobot.modules.helper_funcs.chat_status import is_user_admin
from KomiRobot.modules.helper_funcs.decorators import KomiRobotcallback, KomiRobotcmd, KomiRobotmsg
from KomiRobot.modules.helper_funcs.misc import paginate_modules
...
@KomiRobotcallback(pattern=r"start_back")
@KomiRobotcmd(command="start", pass_args=True)
...
@KomiRobotcallback(pattern=r"help_")
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/KomiRobot'),
...
@KomiRobotcallback(pattern=r"stngs_")
...
@KomiRobotmsg(Filters.status_update.migrate)
