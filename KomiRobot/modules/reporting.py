...
from KomiRobot import DRAGONS, LOGGER, TIGERS, WOLVES
...
from KomiRobot.modules.sql import reporting_sql as sql
...
@KomiRobotcmd(command="report", filters=Filters.chat_type.groups, group=REPORT_GROUP)
@KomiRobotmsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
...
@KomiRobotcallback(pattern=r"report_")
